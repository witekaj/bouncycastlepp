// 
// File:   DerGeneralizedTime.h
// Author: Adam Augustyn
//         CryptoTech, http://www.cryptotech.com.pl
//
// Created on December 12, 2007, 8:50 AM
//

#ifndef _DERGENERALIZEDTIME_H
#define	_DERGENERALIZEDTIME_H
...
namespace org {
  namespace bouncycastle {
    namespace asn1 {
       ...
       */
      class DerGeneralizedTime : public Asn1Object {
      private:
      ...
      public:
         ...
         *               be converted.
         */
        static DerGeneralizedTime GetInstance(Asn1TaggedObject obj, bool explicitly) {
         ...
         */
        DerGeneralizedTime(DateTime time) {
      ...
      private:
        ...
        DateTime ParseDateString(string	dateStr, string formatStr, bool makeUniversal) {
