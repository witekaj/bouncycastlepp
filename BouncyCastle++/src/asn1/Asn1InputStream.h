// 
// File:   Asn1InputStream.h
// Author: Adam Augustyn
//         CryptoTech, http://www.cryptotech.com.pl
//
// Created on November 23, 2007, 9:01 AM
//

#ifndef _ASN1INPUTSTREAM_H
#define	_ASN1INPUTSTREAM_H
  ...
  namespace bouncycastle {
    namespace asn1 {
      ...
      private:
        ...
        class EosAsn1Object : Asn1Object {
        protected:
      ...
      private:
        static readonly Asn1Object EndOfStream = new EosAsn1Object();
      ...
      internal void ReadFully(byte[]  bytes) {
        ...
        if (left != 0) {
           ...
           * from.
           */
      internal Asn1Object BuildObject(int tag, int tagNo, byte[] bytes) {
          ...
          default: {
            ...
            if ((tag & Asn1Tags.Tagged) != 0) {
              ...
              if (bytes.Length == 0) { // empty tag!
                Asn1Encodable ae = isImplicit ?	(Asn1Encodable) DerNull.Instance :	new DerSequence();
      ...
      private:
        ...
        byte[] ReadIndefiniteLengthFully() {
        ...
        BerOctetString BuildConstructedOctetString(Asn1Object sentinel) {
        ...
        BerOctetString BuildDerConstructedOctetString(byte[] input) {
          Asn1InputStream aIn = new Asn1InputStream(input);
          return aIn.BuildConstructedOctetString(null);
        }

        Asn1EncodableVector BuildEncodableVector(Asn1Object sentinel) {
          Asn1EncodableVector v = new Asn1EncodableVector();
          Asn1Object o;
          while ((o = ReadObject()) != sentinel) {
            v.Add(o);
        ...
        Asn1EncodableVector BuildDerEncodableVector(byte[] input) {
          Asn1InputStream aIn = new Asn1InputStream(input);
