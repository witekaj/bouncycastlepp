...
//
// Created on December 11, 2007, 10:05 AM
//

#ifndef _DERBMPSTRING_H
#define	_DERBMPSTRING_H
  ...
  namespace bouncycastle {
    namespace asn1 {
      ...
      public:
         ...
         *              be converted.
         */
        static DerBmpString GetInstance(Asn1TaggedObject obj, bool explicitly) {
